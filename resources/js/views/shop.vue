    ...
    <section class="shop spad">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7">
                        <div class="shop__option__search">
                            <form action="#">
                                ...
                                </select><div class="nice-select" tabindex="0"><span class="current">Categories</span><ul class="list"><li data-value="" class="option selected">Categories</li><li data-value="" class="option">Red Velvet</li><li data-value="" class="option">Cup Cake</li><li data-value="" class="option">Biscuit</li></ul></div>
                    ...
                    <div class="col-lg-5 col-md-5">
                        <div class="shop__option__right">
                            ...
                            </select><div class="nice-select" tabindex="0"><span class="current">Default sorting</span><ul class="list"><li data-value="" class="option selected">Default sorting</li><li data-value="" class="option">A to Z</li><li data-value="" class="option">1 - 8</li><li data-value="" class="option">Name</li></ul></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/shop/product-9.jpg" style="background-image: url(&quot;img/shop/product-9.jpg&quot;);">
                            <div class="product__label">
                                <span>Cupcake</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/shop/product-10.jpg" style="background-image: url(&quot;img/shop/product-10.jpg&quot;);">
                            <div class="product__label">
                                <span>Cupcake</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/shop/product-11.jpg" style="background-image: url(&quot;img/shop/product-11.jpg&quot;);">
                            <div class="product__label">
                                <span>Cupcake</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="img/shop/product-12.jpg" style="background-image: url(&quot;img/shop/product-12.jpg&quot;);">
                            <div class="product__label">
                                <span>Cupcake</span>
                            </div>
                        </div>
